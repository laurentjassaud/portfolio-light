    ...
    export default {
		...
		methods: {
            ...
            createFilter() {
                ...
                this.app.stage.addChild(this.displacementSprite, this.displacementSprite2)                
            ...
            animateFilters() {
                ...
                if ( this.id !== 'work-pixi'){
                    ...
                    this.app.ticker.add((delta) => {
                        //this.displacementFilter2.scale.x  += 1
                        //this.displacementFilter2.scale.x  += 0.5 * delta
                        //this.displacementSprite2.position.x  -= 2 * delta
                        this.displacementFilter2.scale.x  += 0.5 * delta
                        this.displacementSprite2.position.x -= 0.5 * delta
                    })
                }
...
*/
            ...
            animateWorkCover() {
                ...
                console.log('BOUGE !!!!', this.displacementFilter2)
                if(this.displacementFilter2 !== undefined) {
                    let refX = this.displacementFilter2.scale.x
                    let attributs2bis = { intensite : refX }

                    TweenMax.to(attributs2bis, 0.9, {
                        intensite: refX + 400,
                        ease: Power2.easeIn,
                        onUpdate:  () => {
                            //this.displacementFilter2.x = attributs2bis.x
                            this.displacementFilter2.scale.x = attributs2bis.intensite
                        },
                        onComplete:  () => {
                            let attributs3bis = { intensite : refX + 400}

                            TweenMax.to(attributs3bis, 0.9, {
                                intensite: 0,
                                ease: Power2.easeOut,
                                onUpdate:  () => {
                                    this.displacementFilter2.scale.x = attributs3bis.intensite
                                },
                                onComplete:  () => {
                                    this.$parent.animationCover = false
                                }
                            })  
                        }
                    })  
